{% test unit_test(model, input_mapping, expected_output, name, description, compare_columns, force_incremental) %}
    {% set test_sql = dbt_datamocktool.get_unit_test_sql(model, input_mapping, force_incremental)|trim %}
